...
#ifndef OPTICAL_NET_DEVICE_H
#define OPTICAL_NET_DEVICE_H
...
/**
 * \defgroup point-to-point OpticalNetDevice
 ...
 *
 * This OpticalNetDevice class specializes the NetDevice abstract
 * base class.  Together with a OpticalChannel (and a peer 
 * OpticalNetDevice), the class models, with some level of 
 ...
 * propagation delay is set in the OpticalChannel).
 */
class OpticalNetDevice : public NetDevice
{
public:
  static TypeId GetTypeId (void);

  /**
   * Construct a OpticalNetDevice
   *
   * This is the constructor for the OpticalNetDevice.  It takes as a
  ...
  /**
   * Destroy a OpticalNetDevice
   *
   * This is the destructor for the OpticalNetDevice.
   */
  virtual ~OpticalNetDevice ();
  ...
  /**
   * Attach a queue to the OpticalNetDevice.
   *
   * The OpticalNetDevice "owns" a queue that implements a queueing 
  ...
  /**
   * Attach a receive ErrorModel to the OpticalNetDevice.
   *
   * The OpticalNetDevice may optionally include an ErrorModel in
  ...
  /**
   * Receive a packet from a connected OpticalChannel.
   *
   * The OpticalNetDevice receives packets from its connected channel
...
private:
  ...
  OpticalNetDevice& operator = (const OpticalNetDevice &);
  OpticalNetDevice (const OpticalNetDevice &);
...
protected:
  ...
  /**
   * The OpticalChannel to which this OpticalNetDevice has been
   * attached.
   * @see class OpticalChannel
   */
  Ptr<OpticalChannel> m_channel;

  /**
   * The Queue which this OpticalNetDevice uses as a packet source.
   * Management of this Queue has been delegated to the OpticalNetDevice
