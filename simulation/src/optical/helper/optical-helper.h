...
/**
 * \brief Build a set of OpticalNetDevice objects
 *
 * Normally we eschew multiple inheritance, however, the classes 
 * PcapUserHelperForDevice and AsciiTraceUserHelperForDevice are
 * "mixins".
 */
class OpticalHelper : public PcapHelperForDevice, public AsciiTraceHelperForDevice
{
public:
  /**
   * Create a OpticalHelper to make life easier when creating point to
   * point networks.
   */
  OpticalHelper ();
  virtual ~OpticalHelper () {}
   ...
   * OpticalNetDevice created through OpticalHelper::Install.
   */
   ...
   *
   * Set these attributes on each ns3::OpticalNetDevice created
   * by OpticalHelper::Install
   */
   ...
   * \param value the value of the attribute to set
   *
   * Set these attribute on each ns3::OpticalChannel created
   * by OpticalHelper::Install
   */
   ...
   *
   * This method creates a ns3::OpticalChannel with the
   * attributes configured by OpticalHelper::SetChannelAttribute,
   * then, for each node in the input container, we create a 
   * ns3::OpticalNetDevice with the requested attributes, 
   * a queue for this ns3::NetDevice, and associate the resulting 
   * ns3::NetDevice with the ns3::Node and ns3::OpticalChannel.
   */
