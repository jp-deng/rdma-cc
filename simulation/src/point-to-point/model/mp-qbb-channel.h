...
namespace ns3
{
   ...
   */
  class MpQbbChannel : public PointToPointChannel
  {
  public:
     ...
     */
    void Attach(Ptr<MpQbbNetDevice> device);
     ...
     */
    Ptr<MpQbbNetDevice> GetQbbDevice(uint32_t i) const;
  ...
  protected:
     ...
     * specified link
     */
    Ptr<MpQbbNetDevice> GetSource(uint32_t i) const;
     ...
     * the specified link
     */
    Ptr<MpQbbNetDevice> GetDestination(uint32_t i) const;
  ...
  private:
    ...
    public:
      ...
      WireState m_state;
      Ptr<MpQbbNetDevice> m_src;
      Ptr<MpQbbNetDevice> m_dst;
    };
