 ...
 */
#ifndef MP_QBB_HELPER_H
#define MP_QBB_HELPER_H
 ...
 * "mixins".
 */
class MpQbbHelper : public PcapHelperForDevice, public AsciiTraceHelperForDevice
{
public:
  /**
  ...
  static void GetTraceFromPacket(TraceFormat &tr, Ptr<MpQbbNetDevice>, Ptr<const Packet> p, uint32_t qidx, Event event, bool hasL2);
  static void PacketEventCallback(FILE *file, Ptr<MpQbbNetDevice>, Ptr<const Packet>, uint32_t qidx, Event event, bool hasL2);
  static void MacRxDetailCallback (FILE* file, Ptr<MpQbbNetDevice>, Ptr<const Packet> p);
  static void EnqueueDetailCallback(FILE* file, Ptr<MpQbbNetDevice>, Ptr<const Packet> p, uint32_t qidx);
  static void DequeueDetailCallback(FILE* file, Ptr<MpQbbNetDevice>, Ptr<const Packet> p, uint32_t qidx);
  static void DropDetailCallback(FILE* file, Ptr<MpQbbNetDevice>, Ptr<const Packet> p, uint32_t qidx);
  static void QpDequeueCallback(FILE *file, Ptr<MpQbbNetDevice>, Ptr<const Packet>, Ptr<MpRdmaQueuePair>);

  void EnableTracingDevice(FILE *file, Ptr<MpQbbNetDevice>);
